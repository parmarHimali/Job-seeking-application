...
//       return next(
//         new ErrorHandler(
//           "Employer is not allowed to access this resourse!",
//           400
//         )
//       );
//     }
...
//     // Find the job by ID and populate postedBy (employer information)
...
//     // Assuming req.user contains the applicant's user ID
...
//       },
//       employerId: {
//         user: employerId._id, // This is the postedBy (employerId) from the Job schema
//         role: "Employer",
//       },
//     });
